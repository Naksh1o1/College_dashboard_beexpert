            ...
            <div className="drawer-profile" style={{ marginBottom: '20px', padding: 0, display: 'flex', alignItems: 'center', gap: '16px' }}>
              ...
              <div style={{ flex: 1 }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px', flexWrap: 'wrap' }}>
                  ...
                  <span className={`status-pill ${student.placementStatus === 'Placed' ? 'success' : student.placementStatus === 'Not Eligible' ? 'warning' : 'neutral'}`}>{student.placementStatus}</span>
                </div>
              </div>
            </div>
